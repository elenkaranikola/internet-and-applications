...
#
# Insert body text from json files into our database, 
...
for index, js in enumerate(json_files):
    with open(os.path.join(path_to_json, js)) as json_file:
        ...
        for spot, j in enumerate(json_text['body_text']):
            text = json_text['body_text'][spot]['text']
            section = json_text['body_text'][spot]['section']
            text_data=(paper_id,spot,text,section)
            add_data = ("INSERT IGNORE INTO body_text "
